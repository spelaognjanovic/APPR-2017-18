...
```{r ponovitev, echo=FALSE, message=FALSE, fig.align='center'}
...
Prvi graf prikazuje prvih deset igralcev, z največ osvojenimi zmagami na Grand Slam turnirjih od leta 1850 pa do danes. Vodilni je Roger Federer z 19 zmagami. Opazimo, da na lestvici ni nobenega bivšega, uspešnega igralca, saj včasih niso tako pogosto zmagovali kot danes, ko posamezni igralec zmaguje kar po več sezon.
...
Ta graf prikazuje povprečno starost igralcev v posamezni sezoni in kako se spreminja skozi leta. Opazimo, da povprečna starost igralcev na tekmovanjih narašča, kar je skladno tudi s prejšnjim grafom. Igralci bodo vedno bolj vzdržljivi, njihova kariera bo trajala dlje, starost ne bo predstavljala takšne ovire. Razlog je tudi v tem, da se življenjska doba podaljšuje, kar predstavlja večjo fizično sposobnost tudi v poznejših letih. Med starejšimi in mlajšimi igralci bo vedno večji razpon, možnost zmage pa za vse enaka.
...
Graf prikazuje hitrost serve za prvih deset moških in žensk. Zanimivo mi je bilo, ko sem opazila, da nobenega moškega iz prvega grafa, ki so trenutno najboljši igralci, ni na tem seznamu igralcev z najmočnejšo servo. Kar pa pove, da si lahko najboljši tudi če nimaš najmočnejše serve. 
...
Na zemljevidu sem upodobila države, ki so kdarkoli od leta 1850 zmagale na Grand Slam turnirjih. Meritev za zgodnejša leta nisem upoštevala, saj se vmes nekatera prvenstva niso odvijala in bi zaradi tega lahko prišlo do odstopanj oz. nekatere države bi lahko bile v prednosti. Hotela sem videti, katere države so najuspešnejše v tenisu. Vodilni in enotni sta si Avstralija in ZDA s 66 zmagami, kar je bilo zelo proti pričakovanjem.  Za takšno izstopanje Avstralije in ZDA pa sklepam, da je prišlo zaradi tega, saj v obeh državah prirejajo Grand Slam turnirja (Odprto prvenstvo Avstralije in Odprto prvenstvo ZDA) in je potem najverjetneje največ udeležencev domačinov, vsaj v preteklosti menim, da je bilo tako zaradi oddaljenosti in težje dostopnosti med kontinenti. Pričakovala sem, da bo obarvanih več držav na sploh, tako pa jih je samo 22.
Najuspešnejša evropska država je Španija s 27 zmagami, takoj za njo pa Švedska s 26 in na tretjem mestu Švica z 22. Glede na to, da se druga dva Grand Slam turnirja (Odprto prvenstvo Francije in Odprto prvenstvo Anglije) izvajata v Evropi, sem pričakavoal večjo uspešnost Evropskih držav.
